...
T = {
    "fr": {
        ...
        "calibration_instruction": "Vous verrez d'abord une grille partiellement remplie. Le chrono démarre quand la grille disparaît.",
    ...
    "en": {
        ...
        "calibration_instruction": "You'll first see a grid partially filled. The timer starts when the grid disappears.",
